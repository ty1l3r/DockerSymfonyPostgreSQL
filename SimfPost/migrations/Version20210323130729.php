 ...
 */
final class Version20210323130729 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE names (id INT NOT NULL, enfants VARCHAR(255) NOT NULL, adultes VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
